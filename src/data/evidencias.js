...
export const EVIDENCIAS = [
...

  {
    ...
    scratchProyectos: [
      ...
      },
      {
        ...
        src: "https://scratch.mit.edu/projects/1324477654/embed",
      },
      {
        numero: "04",
        titulo: "Proyecto Scratch 4",
        descripcion: "Espacio preparado para incrustar el cuarto proyecto de Scratch.",
        src: "https://scratch.mit.edu/projects/1324478003/embed",
      },
    ],
    destacada: false,
  },
  ...
  },
  {
    ...
    videosLocales: [
      {
        titulo: "Brújula",
        descripcion: "Video demostrativo de la aplicación Brújula desarrollada en App Inventor.",
        archivo: "Brujula.mp4",
        ruta: assetPath("/Evidencias/corte2/videos/Brujula.mp4"),
      },
      {
        titulo: "Saludo",
        descripcion: "Video demostrativo de la aplicación Saludo desarrollada en App Inventor.",
        archivo: "Saludo.mp4",
        ruta: assetPath("/Evidencias/corte2/videos/Saludo.mp4"),
      },
    ],
    destacada: false,
  },
  {
    ...
    videosLocales: [
      {
        titulo: "Ejercicio 1 - Agregar Usuario",
        descripcion: "Video demostrativo del ejercicio 1: agregar usuario en la aplicación.",
        archivo: "Ejercicio1.mp4",
        ruta: assetPath("/Evidencias/corte2/videos/Ejercicio1.mp4"),
      },
      {
        titulo: "Ejercicio 2 - Registro Estudiante",
        descripcion: "Video demostrativo del ejercicio 2: registro de estudiante.",
        archivo: "Ejercicio2.mp4",
        ruta: assetPath("/Evidencias/corte2/videos/Ejercicio2.mp4"),
      },
      {
        titulo: "Ejercicio 3 - Login Administrador",
        descripcion: "Video demostrativo del ejercicio 3: sistema de login para administrador.",
        archivo: "Ejercicio3.mp4",
        ruta: assetPath("/Evidencias/corte2/videos/Ejercicio3.mp4"),
      },
      {
        titulo: "Ejercicio 4 - Registro Pacientes",
        descripcion: "Video demostrativo del ejercicio 4: sistema de registro de pacientes.",
        archivo: "Ejercicio4.mp4",
        ruta: assetPath("/Evidencias/corte2/videos/Ejercicio4.mp4"),
      },
    ],
    youtubeVideos: [
      { titulo: "Video demostrativo 1", src: "https://www.youtube.com/embed/xWPi5AKicos?si=9NZ_Qk96gJGPA15Q" },
      { titulo: "Video demostrativo 2", src: "https://www.youtube.com/embed/kAd3qoYIJFM?si=ShDcdIdCJddbqq8V" },
      { titulo: "Video demostrativo 3", src: "https://www.youtube.com/embed/8R1oVYqIl6U?si=j0-k-gFg72oz1V5j" },
      { titulo: "Video demostrativo 4", src: "https://www.youtube.com/embed/ULgrjE3asZA?si=dMQP7iQlNwgsqpmB" },
    ],
    destacada: false,
  },
];

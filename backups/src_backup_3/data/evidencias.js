...
export const EVIDENCIAS = [
...

  {
    ...
    color: "#A8C83A",
    emoji: "🧩",
    tags: ["Corte 2", "Scratch", "Programación visual"],
    destacada: false,
  },
  {
    id: 13,
    ...
    color: "#2F6F9F",
    emoji: "📱",
    tags: ["Corte 2", "App Inventor", "Fundamentos"],
    destacada: false,
  },
  {
    id: 14,
    ...
    color: "#3D5AF1",
    emoji: "🚀",
    tags: ["Corte 2", "Aplicación móvil", "App Inventor"],
    destacada: false,
  },
  {
    id: 15,
    ...
    color: "#2A9D8F",
    emoji: "🗂️",
    tags: ["Corte 2", "CRUD", "Gestión de datos"],
    destacada: false,
  },
];
...
export const SEGUNDO_CORTE = {
  ...
  descripcion:
    "En esta sección se anexan las actividades del segundo corte, enfocadas en programación visual, Scratch, App Inventor, creación de aplicaciones móviles y gestión de datos.",
  banner: "CORTE 2",
  actividades: EVIDENCIAS.filter((item) => item.semana === "Corte 2"),
};
